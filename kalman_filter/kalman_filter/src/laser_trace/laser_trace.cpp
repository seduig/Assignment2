...
double map_calc_range(double ox, double oy, double oa, int map_width, int map_height,
  ...
  x0 = (int((ox - map_origin_x) / map_resolution + 0.5 + 10000)-10000 + map_width / 2);
  y0 = (int((oy - map_origin_y) / map_resolution + 0.5 + 10000)-10000 + map_height / 2);
  
  x1 = (int(((ox + max_range * cos(oa)) - map_origin_x) / map_resolution + 0.5 +10000)-10000 + map_width / 2); 
  y1 = (int(((oy + max_range * sin(oa)) - map_origin_y) / map_resolution + 0.5 +10000)-10000 + map_height / 2);
